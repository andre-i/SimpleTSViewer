...
class HelpFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        showText(view.findViewById<TextView>(R.id.help_content))
        // back button action
    ...
    private fun showText( page : TextView){
        val text = resources.getText(R.string.help_channel).toString()
        val help = Html.fromHtml(text)
        page.setText(help)
    }
